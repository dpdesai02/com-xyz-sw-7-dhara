package com.xyzbank.propertyreader;
...
public class PropertyReader {
    ...
    */
    ...
    public String getProperty(String propertyName) {
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/com/xyzbank/resources/propertiesfile/config.properties");
